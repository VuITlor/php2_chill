    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="price" name="price" value="<?= isset($_POST['price']) ? $_POST['price'] : ''; ?>" step="0.01">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="base_price" name="base_price" value="<?= isset($_POST['base_price']) ? $_POST['base_price'] : ''; ?>" step="0.01">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="quantity" name="quantity" value="<?= isset($_POST['quantity']) ? $_POST['quantity'] : ''; ?>" step="0.01">
            ...
            <div class="col-md-12 mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="4"><?= isset($_POST['description']) ? $_POST['description'] : ''; ?></textarea>
